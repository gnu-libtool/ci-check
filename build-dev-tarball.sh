...
# Apply patches.
(cd "$package" && patch -p1 < ../patches/0001-libtool.m4-Add-a-darwin-specific-rpath-flag.patch &&
patch -p1 < ../patches/0001-link-order2.at-Specify-rpath-for-program-link-to-dep.patch)
